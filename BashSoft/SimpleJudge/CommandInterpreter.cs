    ...
    public static class CommandInterpreter
    {
        ...
        private static void TryOrderAndTake(string input, string[] data)
        {
            if (data.Length == 5)
            {
                ...
                TryParseParametersForOrderAndTake(takeCommand, takeQuantity, course, filter);
            }
        }
        private static void TryFilterAndTake(string input, string[] data)
        {
            if (data.Length == 5)
            {
                ...
                TryParseParametersForFilterAndTake(takeCommand, takeQuantity, course, filter);
            }
            else
            {
                DisplayInvalidCommandMessage(input);
        ...
        private static void TryParseParametersForFilterAndTake(string takeCommand, string takeQuantity, string course, string filter)
        {
            if (takeCommand == "take")
            {
                if (takeQuantity == "all")
        ...
        private static void TryShowWantedData(string input, string[] data)
        {
            if (data.Length == 2)
            {
                ...
                StudentsRepository.GetAllStudetsFromCourse(courseName);
            }
        ...
        {
            OutputWriter.DisplayException(string.Format($"The command '{input}' is invalid", input));
        }
    }
}
